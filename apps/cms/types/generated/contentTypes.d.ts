...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    socialUrl: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_entries: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiVideoEntryVideoEntry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    niche: Schema.Attribute.Enumeration<
      ['gaming', 'motion_graphics', 'education', 'entertainment', 'other']
    >;
